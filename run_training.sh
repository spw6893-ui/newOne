...
if [ "${1:-}" = "--help" ] || [ "${1:-}" = "-h" ]; then
    echo "用法:"
    echo "  ./run_training.sh [baseline|explore20|explore20_icir|explore20_faststable|explore20_lcb|explore20_ucblcb|explore20_ucblcb_fast|explore20_ucblcb_cs|explore20_ucblcb_cs_breakplateau|explore20_ucblcb_cs_breakplateau_prune|explore20_ucblcb_cs_val]"
    echo ""
    echo "示例:"
